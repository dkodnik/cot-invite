<?php
	$openinviter_settings=array(
		...
		"private_key"=>"",
		"cookie_path"=>'/tmp',
		"message_body"=>"You are invited to hello.com", // hello.com is the website on your account. If wrong, please update your account at OpenInviter.com
		"message_subject"=>" is inviting you to hello.com", // hello.com is the website on your account. If wrong, please update your account at OpenInviter.com
